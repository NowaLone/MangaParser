...
namespace MangaParser.Parsers.Tests.HtmlWebParsers.MintManga
{
    ...
    public class MintMangaParserTests : ReadMangaParserTests
    {
        ...
        [TestMethodDelay()]
        [DataRow("Taimadou", DisplayName = "'Taimadou Gakuen' query")]
        ...
        [TestMethodDelay()]
        [DataRow("https://mintmanga.live/antimagicheskaia_akademiia__35_e_eksperimentalnoe_podrazdelenie_", DisplayName = "'Taimadou Gakuen' url")]
        ...
        [TestMethodDelay()]
        [DataRow("https://mintmanga.live/antimagicheskaia_akademiia__35_e_eksperimentalnoe_podrazdelenie_", DisplayName = "'Taimadou Gakuen' chapters")]
        ...
        [TestMethodDelay()]
        [DataRow("https://mintmanga.live/antimagicheskaia_akademiia__35_e_eksperimentalnoe_podrazdelenie_/vol1/1", DisplayName = "'Taimadou Gakuen' ch1 pages")]
        [DataRow("https://mintmanga.live/antimagicheskaia_akademiia__35_e_eksperimentalnoe_podrazdelenie_/vol3/16", DisplayName = "'Taimadou Gakuen' ch16 pages")]
        ...
        [DataRow("https://mintmanga.live/to_love_ru/vol6/52?mtr=1", DisplayName = "'To Love-Ru' ch52 pages")]
